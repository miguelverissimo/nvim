return {
  ...
  opts = {
    spec = {
      ...
      { "<leader>cf", "<cmd>ClaudeFix<cr>",      desc = "Fix" },
      { "<leader>cr", "<cmd>ClaudeRefactor<cr>", desc = "Refactor" },
      { "<leader>ct", "<cmd>ClaudeTest<cr>",     desc = "Test" },
      { "<leader>cd", "<cmd>ClaudeDoc<cr>",      desc = "Doc" },
      { "<leader>cn", "<cmd>ClaudeRename<cr>",   desc = "Rename" },
      { "<leader>co", "<cmd>ClaudeOptimize<cr>", desc = "Optimize" },
      { "<leader>cD", "<cmd>ClaudeDebug<cr>",    desc = "Debug" },
      { "<leader>ca", "<cmd>ClaudeAnalyze<cr>",  desc = "Analyze" },
      { "<leader>ce", ":ClaudeExplain<cr>",  desc = "Explain selection",  mode = "v" },
      { "<leader>cf", ":ClaudeFix<cr>",      desc = "Fix selection",      mode = "v" },
      { "<leader>cr", ":ClaudeRefactor<cr>", desc = "Refactor selection", mode = "v" },
      { "<leader>ct", ":ClaudeTest<cr>",     desc = "Test selection",     mode = "v" },
      { "<leader>cd", ":ClaudeDoc<cr>",      desc = "Doc selection",      mode = "v" },
      { "<leader>cn", ":ClaudeRename<cr>",   desc = "Rename in selection", mode = "v" },
      { "<leader>co", ":ClaudeOptimize<cr>", desc = "Optimize selection",  mode = "v" },
      { "<leader>cD", ":ClaudeDebug<cr>",    desc = "Debug selection",    mode = "v" },
      { "<leader>ca", ":ClaudeAnalyze<cr>",  desc = "Analyze selection",  mode = "v" },
