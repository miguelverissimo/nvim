return {
  ...
  opts = {
    spec = {
      ...
      { "<leader>cG", desc = "Commit" },
      { "<leader>cR", desc = "Review" },
      { "<leader>cp", desc = "PR" },
      { "<leader>cP", desc = "Plan" },
      { "<leader>ca", desc = "Analyze" },
      { "<leader>cD", desc = "Debug" },
      { "<leader>cA", desc = "Apply" },
      { "<leader>cx", desc = "Context" },
      { "<leader>ce", desc = "Explain selection",  mode = "v" },
      { "<leader>cf", desc = "Fix selection",      mode = "v" },
      { "<leader>cr", desc = "Refactor selection", mode = "v" },
      { "<leader>ct", desc = "Test selection",     mode = "v" },
      { "<leader>cd", desc = "Doc selection",      mode = "v" },
      { "<leader>cn", desc = "Rename in selection", mode = "v" },
